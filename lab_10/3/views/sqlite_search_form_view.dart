...
class SQLiteSearchFormView extends StatefulWidget {
  final SQLiteInsertAndUpdateModel? student;

  const SQLiteSearchFormView({super.key, this.student});

  @override
  State<SQLiteSearchFormView> createState() =>
      _SQLiteSearchFormViewState();
}

class _SQLiteSearchFormViewState
    extends State<SQLiteSearchFormView> {
  final controller = Get.find<SQLiteSearchController>();
