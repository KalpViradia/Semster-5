...
class SQLiteLazyLoadingFormView extends StatefulWidget {
  final SQLiteLazyLoadingModel? student;

  const SQLiteLazyLoadingFormView({super.key, this.student});

  @override
  State<SQLiteLazyLoadingFormView> createState() =>
      _SQLiteLazyLoadingFormViewState();
}

class _SQLiteLazyLoadingFormViewState
    extends State<SQLiteLazyLoadingFormView> {
  final controller = Get.find<SQLiteLazyLoadingController>();
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    final student = SQLiteLazyLoadingModel(
