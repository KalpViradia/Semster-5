...
class SQLiteInsertAndUpdateDatabase {
  static final SQLiteInsertAndUpdateDatabase instance = SQLiteInsertAndUpdateDatabase._init();
  static Database? _database;

  SQLiteInsertAndUpdateDatabase._init();
