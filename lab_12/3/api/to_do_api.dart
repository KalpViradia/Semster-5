...
class TodoApiService extends GetConnect implements ApiService {
  final String baseUrl = 'https://66ed2084380821644cdb7fe9.mockapi.io/todos';

  @override
  Future<List<Todo>> fetchTodos() async {
    final res = await get(baseUrl);
  ...
  Future<void> addTodo(Todo todo) async {
    await post(baseUrl, todo.toJson());
  }

  @override
  Future<void> updateTodo(String id, Todo todo) async {
    await put('$baseUrl/$id', todo.toJson());
  }
