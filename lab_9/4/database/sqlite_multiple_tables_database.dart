...
class SQLiteMultipleTablesDatabase {
  static final SQLiteMultipleTablesDatabase instance = SQLiteMultipleTablesDatabase._init();
  static Database? _database;

  SQLiteMultipleTablesDatabase._init();
