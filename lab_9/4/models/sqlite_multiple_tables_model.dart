// on upgrade add 3 tables
// university
// semester
// branch
// list name sem, branch and uni

import 'package:advance_flutter_lab/lab_9/4/utils/import_export.dart';

class SQLiteMultipleTablesModel {
  final int? id;
  final String name;
  ...
  factory SQLiteMultipleTablesModel.fromMap(Map<String, dynamic> map) {
    return SQLiteMultipleTablesModel(
      id: map[COL_ID],
      name: map[COL_NAME],
