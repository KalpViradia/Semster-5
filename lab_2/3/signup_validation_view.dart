...
class SignupValidationView extends StatefulWidget {
  const SignupValidationView({super.key});

  @override
  State<SignupValidationView> createState() => _SignupValidationViewState();
}

class _SignupValidationViewState extends State<SignupValidationView> {
  final SignupValidationController _signupController = SignupValidationController();
